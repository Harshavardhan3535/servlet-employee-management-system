...
public class RegisterEmployeeController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//read the form data by using getParameter()
		...
		//call register method save the method
		
		EmployeeDao dao=new EmployeeDao();
		
		boolean b=dao.registerEmployee(emp);
		if(b) {
			System.out.println("Data is Inserted");
			//after registration re-direct to home page
